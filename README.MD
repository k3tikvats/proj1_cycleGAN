...
The model does 2-band to 13-band conversion.
The link to downloading ZipFile for the project :- [Link](https://github.com/k3tikvats/proj1_cycleGAN/archive/refs/heads/main.zip)
